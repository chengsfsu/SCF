...
#一共有三个文件，第一个文件通过换算法用来解决收敛问题，第二个文件定义了静力分析参数，第三个文件定义了整个推覆的过程，到底是循环往复还是单调推覆
...
set Dincr [expr 0.0002*$HBuilding ];	# displacement increment for pushover. you want this to be very small, but not too small to slow analysis
