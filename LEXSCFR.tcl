...
proc LEXSCFR {nodeTag nodeLocationX nodeLocationY elementTag  storyTag } {
...
element twoNodeLink [expr $elementTag+50] [expr $nodeTag+4] [expr $nodeTag+15] -mat $matID_D10($storyTag)  -dir 1;

element twoNodeLink [expr $elementTag+51] [expr $nodeTag+7] [expr $nodeTag+17] -mat $matID_D10($storyTag)  -dir 1;	

# 定义梁柱仅受压接触单元


element zeroLength  [expr $elementTag+58] [expr $nodeTag+30] [expr $nodeTag+18] -mat [expr $matID_G1($storyTag)] -dir 1;
element zeroLength  [expr $elementTag+59] [expr $nodeTag+31] [expr $nodeTag+42] -mat [expr $matID_G2($storyTag)] -dir 1;
element zeroLength  [expr $elementTag+60] [expr $nodeTag+32] [expr $nodeTag+43] -mat [expr $matID_G3($storyTag)] -dir 1;
element zeroLength  [expr $elementTag+61] [expr $nodeTag+33] [expr $nodeTag+44] -mat [expr $matID_G3($storyTag)] -dir 1;
element zeroLength  [expr $elementTag+62] [expr $nodeTag+34] [expr $nodeTag+45] -mat [expr $matID_G2($storyTag)] -dir 1;
element zeroLength  [expr $elementTag+63] [expr $nodeTag+35] [expr $nodeTag+20] -mat [expr $matID_G1($storyTag)] -dir 1;



element zeroLength  [expr $elementTag+65] [expr $nodeTag+30] [expr $nodeTag+18] -mat [expr $matID_G5($storyTag)] -dir 1;
element zeroLength  [expr $elementTag+66] [expr $nodeTag+31] [expr $nodeTag+42] -mat [expr $matID_G5($storyTag)] -dir 1;
element zeroLength  [expr $elementTag+67] [expr $nodeTag+32] [expr $nodeTag+43] -mat [expr $matID_G5($storyTag)] -dir 1;
element zeroLength  [expr $elementTag+68] [expr $nodeTag+33] [expr $nodeTag+44] -mat [expr $matID_G5($storyTag)]  -dir 1;
element zeroLength  [expr $elementTag+69] [expr $nodeTag+34] [expr $nodeTag+45] -mat [expr $matID_G5($storyTag)]  -dir 1;
element zeroLength  [expr $elementTag+70] [expr $nodeTag+35] [expr $nodeTag+20] -mat [expr $matID_G5($storyTag)]  -dir 1;
